...
public class SharedPreferencesAdapter {
  ...
  private void initDefaults() {
    ...
    if (getString(Constants.PREF_NAME_KEY, null) == null)
      setPreference(Constants.PREF_NAME_KEY, Constants.PREF_NAME_DEFAULT);
    if( getString(Constants.PREF_LOCATION_KEY, null) == null)
      setPreference(Constants.PREF_LOCATION_KEY, Constants.PREF_LOCATION_DEFAULT);	
  }
