...
public class Constants {
   ...
   * Tag for debugging.
   */
  public static final String TAG = "OdkTasks";
  ...
  /**
   * The path (relative to the ODK manage server domain) to the task update (modified tasks)
   * URL.
   */
  public static final String TASK_UPDATE_PATH = "taskUpdate";
  ...
  /**
   * The name of the phone user
   */
  public static final String PREF_NAME_KEY = "userName";

  /**
   * The general location of the phone user 
   */
  public static final String PREF_LOCATION_KEY = "userLocation";

  /**
   * The name of the phone user
   */
  public static final String PREF_NAME_DEFAULT = " ";

  /**
   * The general location of the phone user 
   */
  public static final String PREF_LOCATION_DEFAULT = " ";
